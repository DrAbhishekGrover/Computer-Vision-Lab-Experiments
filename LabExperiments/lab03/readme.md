...
3. (Exercise) To verify the result in S.No.2: Find the true physical focal length (f) and pixel density (p) (in mm) of your main camera from internet sources. The ration (f/p) should match with K(1,1) element of intrinsic matrix.
